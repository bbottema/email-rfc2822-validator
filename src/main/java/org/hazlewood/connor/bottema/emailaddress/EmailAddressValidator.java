 ...
 * <p>
 * <strong>Limitations</strong>: doesn't support nested CFWS (comments within (other) comments), doesn't support mailbox groups except when flat-extracting addresses from
 ...
 * <p>
 * <code>bob @example.com</code><br>
 * <code>&quot;bob&quot;  @  example.com</code><br>
 * <code>bob (comment) (other comment) @example.com (personal name)</code><br>
 * <code>&quot;&lt;bob \&quot; (here) &quot; &lt; (hi there) &quot;bob(the man)smith&quot; (hi) @ (there) example.com (hello) &gt; (again)</code>
 * <p>
 ...
 * <code>&lt;bob@example.com&gt;</code><br>
 * <code>&lt;bob@example.com&gt;</code><br>
 * <code>&quot;personal name&quot; &lt;bob@example.com&gt;</code><br>
 * <code>&quot;&lt;bob\&quot; (here)&quot; &lt;&quot;bob(the man)smith&quot;@example.com&gt;</code><br>
 * (respectively)
 * <p>
...
public final class EmailAddressValidator {
	 ...
	 * spaces in addresses ("bob @hi.com") are valid according to 2822! Read the docs for this class before using this method!</b>
	 * <p>
	 * <strong>Note 1:</strong> By passing a criteria in to this method, you are overriding the criteria entirely, not extending it. E.g. you may want to
	 * include both {@link EmailAddressCriteria#ALLOW_QUOTED_IDENTIFIERS} and {@link EmailAddressCriteria#ALLOW_PARENS_IN_LOCALPART} in addition to whatever
	 * additional criteria you desire
	 * <p>
	 * <strong>Note 2:</strong> If being used on a 2822 header, this method applies to Sender, Resent-Sender, <b>only</b>, although you can also use it on the
	 * Return-Path if you know it to be non-empty (see doc for isValidReturnPath()!). Folded header lines should work OK, but I haven't tested that.
	 *
